...
/** Trait that defines operation that are safe to execute only (has also a
  * meaning) on a finite stream <p>NB : A finite stream extends the API of the
  * infinite stream.</p>
  *
  * @tparam T
  */
trait FiniteXStream[T] extends XStream[T] {
  ...
  /** Returns the biggest element of this stream using the given comparator.
    * <ul> <li>None if the stream is empty.</li> <li>The biggest even there is
    * duplicates.</li> </ul>
    *
    * @param comparator
    * @return
  ...
  /** Returns the smallest element of this stream using the given comparator.
    * <ul> <li>None if the stream is empty.</li> <li>The smallest even there is
    * duplicates.</li> </ul>
    *
    * @param comparator
    * @return
  ...
  /** Returns a new finite stream that concatenate this stream with another one.
    *
    * <p>This overload of the concat method, force the return type to be
    * FiniteXStream if the other stream is also finite</p>
    *
    * @param other
    * @return
    */
  ...
  /** Returns True if all the elements of this stream matches the given
    * predicate. Otherwise it returns False <p>It doesn't traverse all the
    * stream in all cases. It stops on the first element that don't match the
    * predicate</p>
    *
    * @param predicate
    * @return
  ...
  /** Returns True if any of the elements of this stream matches the given
    * predicate. Otherwise it returns False.
    *
    * <p>It doesn't traverse all the stream in all the cases. It stops on the
    * first element that don't match the predicate</p>
    *
    * @param predicate
    * @return
    */
